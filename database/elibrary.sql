...
INSERT INTO `books` (`id`, `name`, `edition`, `author`, `description`, `copies`, `image`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `borrow_books` (`id`, `student_id`, `book_id`, `returning_date`, `returned_date`, `is_returned`, `is_agreed`, `created_at`, `updated_at`) VALUES
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `email`, `phone`, `password`, `country`, `state`, `city`, `address`, `postal_code`, `is_role`, `is_active`, `created_at`, `updated_at`) VALUES
